...
<body>
    ...
    <div class="easyui-panel" title="Ingresar nuevo pedido" style="width:100%;max-width:400px;padding:30px 60px;">
        <form id="ff" method="post" action= "http://localhost/bodegas/models/insertarDetalle.php" >
            ...
            <div style="margin-bottom:20px">
                <!--<input id="cant" class="easyui-textbox" name="cantidad" style="width:100%" data-options="label:'Cantidad:',required:true">-->
        ...
        <!--<div style="text-align:center;padding:5px 0">
            <a href="javascript:void(0)" id="enviar" class="enviar easyui-linkbutton" onclick="submitForm()" style="width:80px">Guardar</a>
